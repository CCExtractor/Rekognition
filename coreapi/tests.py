...
from .models import InputImage, InputVideo, SimilarFaceInImage, InputEmbed, NameSuggested
...
class TestInputImage(TestCase):
    ...
    def setUp(self):
        ...
        self.obj2 = InputImage.objects.create(title='test_name_2', isProcessed=True)
    ...
    def test_InputImage_model_creation(self):
        ...
        self.assertEqual(test_name_1.isProcessed, False)
        ...
        self.assertEqual(test_name_2.isProcessed, True)
...
class TestInputVideo(TestCase):
    ...
    def setUp(self):
        ...
        self.obj2=InputVideo.objects.create(title='test_name_2', isProcessed=True)
...
class TestNameSuggested(TestCase):
    ...
    def setUp(self):
        ...
        self.obj1=NameSuggested.objects.create(suggestedName=self.embed.title, feedback=self.embed)


    def test_model_creation(self):

        test_name_1 = NameSuggested.objects.get(suggestedName='test_name_1')
        self.assertEqual(test_name_1.suggestedName, self.embed.title)
